...
runHoverTestSuite({
    ...
    hoverTestCases: [
        ...
        { element: 'webApplication element', line: 24, column: 10, expectedDoc: 'Defines the properties of a web application.' },
        ...
        { element: 'platform element', line: 18, column: 9, expectedDoc: 'Specifies a platform to be used when the server runs.' },
        { element: 'mpHealth-4.0 feature value', line: 17, column: 18, expectedDoc: 'This feature provides support for the MicroProfile Health specification.' }
    ]
});
