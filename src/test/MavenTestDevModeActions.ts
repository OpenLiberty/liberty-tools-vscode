...
import { InputBox, Workbench,SideBarView, ViewItem, ViewSection,EditorView, DefaultTreeItem ,  DebugView, TextEditor, VSBrowser, TitleBar } from 'vscode-extension-tester';
