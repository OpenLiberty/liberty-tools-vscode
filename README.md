...
- Supported Liberty projects will appear in the Liberty Dashboard on the sidebar. Right-click a project in the Liberty Dashboard to view the available commands.
