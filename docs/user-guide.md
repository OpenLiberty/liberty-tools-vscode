...
In all the cases above, you will be prompted in the Command Palette to select a project to add from a list of projects that are currently not displayed in the Liberty dashboard.<br>
